...
export const metadata = {
  ...
  description: "پلن‌های اشتراک متنوع برای سیستم مدیریت املاک آرامش. پلن‌های پایه، حرفه‌ای و سازمانی با امکانات مختلف برای نیازهای متنوع کسب‌وکارهای املاک.",
  keywords: "پلن اشتراک املاک, تعرفه سیستم املاک, نرم‌افزار مدیریت املاک, سامانه املاک آنلاین, پنل مشاورین املاک, سیستم CRM املاک",
  openGraph: {
    title: "تعرفه‌ها و پلن‌های اشتراک | سیستم مدیریت املاک آرامش",
...
const jsonLd = {
  ...
  description: 'سامانه جامع مدیریت املاک، مشاورین و properties با قابلیت‌های پیشرفته',
  offers: {
    '@type': 'AggregateOffer',
    offerCount: 3,
    lowPrice: 2900000,
