...
export async function generateMetadata() {
  return {
    ...
    description:
      "مشاهده لیست کامل مشاورین املاک در سیستم مدیریت املاک آرامش. ارتباط مستقیم با مشاورین متخصص در زمینه خرید، فروش و اجاره املاک.",
    keywords:
      "مشاورین املاک, لیست مشاورین, املاک آرامش, مشاورین متخصص, خرید ملک, فروش ملک, اجاره ملک",
