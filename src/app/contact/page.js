...
export async function generateMetadata() {
  return {
    ...
    description:
      "ارسال پیام به پشتیبانی سیستم مدیریت املاک آرامش. پاسخگویی سریع به سوالات، مشکلات فنی و پیشنهادات شما.",
    keywords:
      "تماس با پشتیبانی, پشتیبانی املاک آرامش, ارسال پیام, مشکلات فنی, راهنمایی سیستم املاک",
