...
$(function() {
    ...
    var a = c3.generate({
        ...
        color: {
            pattern: [" #689f38  ", "  #38649f  "]
        },
        data: {
            columns: [
                ["داده 1 ", 150, 350, 190, 500, 400, 240],
                ["داده 2 ", 60, 160, 45, 60, 45, 65]
            ],
            types: {
                data1: "bar"
            }
    ...
    var t = c3.generate({
        ...
        color: {
            pattern: ["#38649f", "#689f38"]
        },
        data: {
            columns: [
                [" داده ", 120, 350, 185, 450, 90, 158, 90, 150, 302]
            ]
        },
        axis: {
            x: {
    ...
    var i = c3.generate({
        ...
        data: {
            columns: [
                [" 1 ", 10, 252, 125, 421, 131, 269, 45, 352, 142, 425, 125, 248, 41, 212, 154, 424, 136]
            ]
        },
        axis: {
            x: {
    ...
    var t = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['داده 1', 50, 250, 125, 452, 189, 269, 548, 125, 65],
                ['داده  2', 142, 324, 245, 562, 268, 345, 412, 214, 32]
    ...
    var n = c3.generate({
        ...
        color: {
            pattern: ["#3f51b5", "#faa700"]
        },
        data: {
            columns: [
                ["نمونه ", 30, -200, 100, 300, 150, -250, 350, 150, 400, -50]
            ]
        },
        axis: {
            y: {
