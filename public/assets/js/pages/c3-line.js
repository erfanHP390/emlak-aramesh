...
$(function() {
    ...
    setTimeout(function() {
        t.load({
            columns: [
                [' 1 ', 230, 190, 300, 500, 300, 400]
            ]
        })
    }, 1e3), setTimeout(function() {
        t.load({
            columns: [
                [' 3 ', 130, 150, 200, 300, 200, 100]
            ]
        })
    ...
    var a = c3.generate({
        ...
        color: {
            pattern: ["#3e8ef7", "#ff4c52"]
        },
        data: {
            columns: [
                [' 1 ', 300, 350, 300, 0, 0, 0],
                [' 2  ', 130, 100, 140, 200, 150, 50]
    ...
    setTimeout(function() {
        o.load({
            columns: [
                [' 1 ', 100, 250, 150, 200, 100, 350]
            ]
        })
    }, 1e3), setTimeout(function() {
        o.load({
            columns: [
                [' 3 ', 80, 150, 100, 180, 80, 150]
            ]
        })
    }, 1500), setTimeout(function() {
        o.unload({
